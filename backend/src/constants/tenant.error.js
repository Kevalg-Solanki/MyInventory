module.exports = {
	...
	TENANT_DEACTIVATED: {
		...
		httpStatus: 403,
		message:
			"Tenant you trying to access is deactivated. If your owner then please visit recovery page by clicking recover my tenant/account in singU1p page.",
	},
	...
	TENANT_DELETED: {
		...
		httpStatus: 410,
		message:
			"Tenant you trying to access is deleted or removed. Please visit recovery page by clicking recover tenant/account in singUp page.",
	},
};
