...
<head>
  ...
  <title>Tenant Invitation - My Inventory</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <!-- Main Content -->
    <div class="content">
      <div class="subtitle">Tenant Invitation</div>
      <h1 class="title">You're Invited to Join [[tenantName]]</h1>
      <p class="message">
        Hello! <strong>[[invitorName]]</strong> has invited you to join <strong>[[tenantName]]</strong> on My Inventory. You have a pending request waiting for you.
      </p>
      ...
      <div class="highlight">
        <strong>Pending Request:</strong> Please log in to your account to review and accept this tenant invitation. You can find your pending requests in your dashboard.
      </div>

      <div class="actions">
        <a href="[[pendingRequestsUrl]]" class="btn btn-primary">View Pending Requests</a>
