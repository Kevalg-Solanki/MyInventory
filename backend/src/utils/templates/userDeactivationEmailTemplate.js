const userDeactivationEmailTemplate = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
  <title>User Account Deactivated - My Inventory</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <!-- Main Content -->
    <div class="content">
      <h1 class="title">User Account Deactivated</h1>
      <p class="message">
        This is to inform you that the user <strong>[[userFullName]]</strong> (<strong>[[userEmail]]</strong>) has been <strong>deactivated</strong> by <strong>[[actedByName]]</strong> on <strong>[[deactivatedAt]]</strong>. While deactivated, this user cannot sign in or perform any actions within this tenant. Access to dashboards, products, and sales is blocked.
      </p>

      <div class="highlight">
        If this action was not intended, you can request reactivation within <strong>[[reactivationWindowHours]]</strong> hours, subject to your role and organization policy.
      </div>
      ...
      <div class="meta">
        ...
        <div class="meta-item">
          ...
          <span class="meta-value">[[userFullName]]</span>
        </div>
        <div class="meta-item">
          ...
          <span class="meta-value">[[userMobile]]</span>
        </div>
        <div class="meta-item">
      ...
      <div class="actions">
        <a href="[[manageUserUrl]]" class="btn btn-primary">Manage User</a>
      ...
      <div class="highlight">
        <strong>Data Access:</strong> The user’s access tokens are invalidated during deactivation. Existing data remains intact, but the user cannot create, update, or delete resources until reactivated.
      </div>
    </div>
...
module.exports = userDeactivationEmailTemplate;
